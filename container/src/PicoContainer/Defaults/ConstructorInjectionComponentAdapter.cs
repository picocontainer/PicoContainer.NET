...
namespace PicoContainer.Defaults
{
    ...
    public class ConstructorInjectionComponentAdapter : InstantiatingComponentAdapter
    {
        ...
        #region Nested type: ConstructorInjectionGuard
        ...
        #region Nested type: ContructorComparator

        private class ContructorComparator : IComparer
        {
            #region IComparer Members

            public int Compare(Object arg0, Object arg1)
            {
                Type[] parameterTypes0 = TypeUtils.GetParameterTypes((ConstructorInfo) arg0);
                Type[] parameterTypes1 = TypeUtils.GetParameterTypes((ConstructorInfo) arg1);
