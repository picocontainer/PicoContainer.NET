...
namespace PicoContainer.Defaults
{
    ...
    public class SetterInjectionComponentAdapter : InstantiatingComponentAdapter
    {
        ...
        public SetterInjectionComponentAdapter(object componentKey,
                                               Type componentImplementation,
                                               IParameter[] parameters)
            : base(componentKey, componentImplementation, parameters, false)
        {
        }
        ...
        #region Nested type: SetterInjectionGuard
        ...
        #region Nested type: VerifyingGuard

        [Serializable]
        private class VerifyingGuard : DefaultVerifyingGuard
        {
