...
namespace PicoContainer.Monitors
{
    ...
    public class ConsoleComponentMonitorTestCase
    {
        ...
        public void ShouldTraceInstantiated()
        {
            ...
            Assert.AreEqual(
                "PicoContainer: instantiated PicoContainer.Monitors.ConsoleComponentMonitorTestCase [543ms]\r\n",
                writer.ToString());
        }
        ...
        public void ShouldTraceInstantiationFailed()
        {
            ...
            Assert.AreEqual(
                "PicoContainer: instantiation failed: PicoContainer.Monitors.ConsoleComponentMonitorTestCase, reason: 'doh'\r\n",
                writer.ToString());
        }
        ...
        public void ShouldTraceInvocatiationFailed()
        {
            ...
            Assert.AreEqual(
                "PicoContainer: invocation failed: PicoContainer.Monitors.ConsoleComponentMonitorTestCase.ToString on Blah, reason: 'doh'\r\n",
                writer.ToString());
        }
        ...
        public void ShouldTraceInvoked()
        {
            ...
            Assert.AreEqual(
                "PicoContainer: invoked PicoContainer.Monitors.ConsoleComponentMonitorTestCase.ToString on Blah [543ms]\r\n",
                writer.ToString());
        }
        ...
        public void ShouldTraceInvoking()
        {
            ...
            Assert.AreEqual(
                "PicoContainer: invoking PicoContainer.Monitors.ConsoleComponentMonitorTestCase.ToString on Blah\r\n",
                writer.ToString());
        }
    }
}