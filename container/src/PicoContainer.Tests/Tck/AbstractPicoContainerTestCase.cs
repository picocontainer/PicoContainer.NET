...
namespace PicoContainer.Tck
{
    ...
    public abstract class AbstractPicoContainerTestCase
    {
        ...
        private ITouchable GetTouchableFromSerializedContainer()
        {
            ...
            pico.RegisterComponentImplementation("list", typeof (ArrayList),
                                                 new IParameter[] {new ConstantParameter(10)});
        ...
        #region Nested type: LifeCycleMonitoring
        ...
        #region Nested type: NeedsTouchable
        ...
        #region Nested type: NeedsWashable
        ...
        #region Nested type: TestLifecycleComponent
        ...
        #region Nested type: TestLifecycleManager
